...
def create_md(lines: list, layout: list):
    for item in lines:
        ...
        # Write the file
        md_filename = os.path.join("../_saisons/", os.path.basename(md_filename))
...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 2:
        print('Usage: python3 saisons.py [filename]', file=sys.stderr)
        sys.exit(EXIT_ERROR)
